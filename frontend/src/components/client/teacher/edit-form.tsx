...
export default function Form({ course }: { course: Course }) {
  ...
  const editCourseWithId = editCourse.bind(null, course.id);
          ...
          <div className="flex gap-3 mt-1">
            <div className="flex items-center gap-1">
              ...
              <input
                ...
                type="radio"
                value="PRIVATE"
                defaultChecked={course.visibility == "PRIVATE"}
            ...
            <div className="flex items-center gap-1">
              ...
              <input
                ...
                type="radio"
                value="PUBLIC"
                defaultChecked={course.visibility == "PUBLIC"}
                className="h-4 w-4 cursor-pointer"
              />
            </div>
          </div>
          ...
          <div className="flex gap-3 mt-1">
            <div className="flex items-center gap-1">
              ...
              <input
                ...
                type="radio"
                value="GEOMETRY"
                defaultChecked={course.subject == "GEOMETRY"}
                className="h-4 w-4 cursor-pointer"
              />
            </div>
            <div className="flex items-center gap-1">
              ...
              <input
                ...
                type="radio"
                value="ALGEBRA"
                defaultChecked={course.subject == "ALGEBRA"}
                className="h-4 w-4 cursor-pointer"
              />
            </div>
          </div>
